...
DISABLE_SSL=${KUBE_DISABLE_SSL:-0}
...
Flags and environment variables:
    ...
    -k    KUBE_DISABLE_SSL                       Disable SSL verification
...
Example:
  ...
  curl -sSL https://raw.githubusercontent.com/idelchi/godyl/refs/heads/dev/scripts/install-tools.sh | sh -s -- -k
